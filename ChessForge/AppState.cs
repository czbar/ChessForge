    ...
    public class AppState
    {
        ...
        private static void EnableModelGamesMenuItems(int selectedNodeId)
        {
            try
            {
                ...
                ConfigureDiagramMenuOptions(MainWin.UiMnGameInsertDiagramPreComment, MainWin.UiMnGameInsertDiagramPostComment
                    , MainWin.UiMnGame_DeleteDiagram, MainWin.UiMnGameInvertDiagram, MainWin.UiMnGameSwapDiagramComment, MainWin.UiMnGameSaveDiagram);
            ...
            try
            {
                ...
                else
                {
                    ...
                    ConfigureDiagramMenuOptions(MainWin.UiMnExercInsertDiagramPreComment, MainWin.UiMnExercInsertDiagramPostComment
                        , MainWin.UiMnExerc_DeleteDiagram, MainWin.UiMnExercInvertDiagram, MainWin.UiMnExercSwapDiagramComment, MainWin.UiMnExercSaveDiagram);
                }
            ...
            )
        {
            ...
            if (nd == null)
            {
                ...
                saveDiagram.Visibility = Visibility.Collapsed;
            }
            else
            {

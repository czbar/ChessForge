...
namespace ChessForge
{
    ...
    /// the entire Workbook.
    /// </summary>
    public class TreeRichTextBuilder : RichTextBuilder
    {
        public TreeRichTextBuilder(FlowDocument doc) : base(doc)
        {
        }
        ...
        {
            ["0"] = new RichTextPara(0, 10, 18, FontWeights.Bold, new SolidColorBrush(Color.FromRgb(0, 0, 0))),
            ["1"] = new RichTextPara(40, 10, 16, FontWeights.Normal, new SolidColorBrush(Color.FromRgb(69, 89, 191))),
            ["2"] = new RichTextPara(70, 5, 14, FontWeights.Normal, new SolidColorBrush(Color.FromRgb(51, 159, 141))),
            ["3"] = new RichTextPara(90, 5, 12, FontWeights.Normal, new SolidColorBrush(Color.FromRgb(120, 61, 172))),
            ["4"] = new RichTextPara(105, 5, 11, FontWeights.Normal, new SolidColorBrush(Color.FromRgb(128, 98, 63))),
            ["default"] = new RichTextPara(110, 5, 11, FontWeights.Normal, new SolidColorBrush(Color.FromRgb(128, 98, 63))),
        };
        ...
        public  void BuildFlowDocumentForWorkbook(int rootNodeId = 0, bool includeStem = true)
        {
            ...
            else
            {
                ...
                if (includeStem)
                {
                    Paragraph paraStem = BuildPrefixParagraph(root);
                ...
                if (nd.Children.Count > 1)
                {
                    ...
                    for (int i = 1; i < nd.Children.Count; i++)
                    {
                        ...
                        if (multi || _currParagraphLevel == 0)
                        {
                            ...
                            {
                                _currParagraphLevel++;
                                para2 = CreateParagraph(_currParagraphLevel);
                        ...
                        {
                            _currParagraphLevel--;
                            para = CreateParagraph(_currParagraphLevel);
                            Document.Blocks.Add(para);
                        }
                        else
                        {
